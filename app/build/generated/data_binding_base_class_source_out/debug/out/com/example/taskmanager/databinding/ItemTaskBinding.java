...
public final class ItemTaskBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView taskScheduledTime;

  @NonNull
  public final TextView taskTitle;

  private ItemTaskBinding(@NonNull MaterialCardView rootView, @NonNull CheckBox taskCheckBox,
      @NonNull TextView taskDescription, @NonNull TextView taskScheduledTime,
      @NonNull TextView taskTitle) {
    this.rootView = rootView;
    this.taskCheckBox = taskCheckBox;
    this.taskDescription = taskDescription;
    this.taskScheduledTime = taskScheduledTime;
  ...
  public static ItemTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.taskScheduledTime;
      TextView taskScheduledTime = ViewBindings.findChildViewById(rootView, id);
